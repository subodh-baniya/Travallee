    ...
    <div className="p-6 bg-slate-50 min-h-screen space-y-4">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6">
        ...
        <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="p-3 rounded-lg bg-slate-50 border border-slate-100"><span className="text-slate-500">Check-in:</span> <span className="font-medium text-slate-800">{formatDateTime(booking.checkInDate)}</span></div>
          <div className="p-3 rounded-lg bg-slate-50 border border-slate-100"><span className="text-slate-500">Check-out:</span> <span className="font-medium text-slate-800">{formatDateTime(booking.checkOutDate)}</span></div>
          ...
          <div className="p-3 rounded-lg bg-slate-50 border border-slate-100"><span className="text-slate-500">Amount:</span> <span className="font-medium text-slate-800">Rs. {booking.amount ?? "-"}</span></div>
