...
const API_ENDPOINTS_HOTEL: ApiEndpoints = {
  ...
  GET_ALL_HOTELS: `${API_HOTEL}/hotels`,
  GET_ALL_RESORTS: `${API_HOTEL}/resorts`,
...
const API_CHAT_SERVICE_REST = `${API_URL}:6001/api/v1/chat`;
const API_ENDPOINTS_CHAT = {
  GET_HISTORY: `${API_CHAT_SERVICE_REST}/history`,
  SOCKET_URL: `${API_URL}:6001`,
};
